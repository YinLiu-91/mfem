...
set(MFEM_VERSION_INT 40201)
set(MFEM_GIT_STRING "heads/master-0-ga9cbcafac29ad58fd43c3640b82a6f745cd36826-dirty")
...
set(MFEM_CXX_COMPILER "C:/Program Files/mingw32/bin/g++.exe")
set(MFEM_CXX_FLAGS "")
...
get_filename_component(PACKAGE_PREFIX_DIR "${CMAKE_CURRENT_LIST_DIR}/C:/Program Files (x86)/mfem" ABSOLUTE)
...
set(MFEM_INCLUDE_DIRS "E:/project/fem/mfem/build")
foreach (dir ${MFEM_INCLUDE_DIRS})
  set_and_check(MFEM_INCLUDE_DIR "${dir}")
endforeach (dir "${MFEM_INCLUDE_DIRS}")

set_and_check(MFEM_LIBRARY_DIR "E:/project/fem/mfem/build")
